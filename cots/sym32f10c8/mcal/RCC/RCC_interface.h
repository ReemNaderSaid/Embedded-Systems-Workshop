...
Std_ReturnType Mcal_Rcc_MultiplicationFactor(u8 *Copy_Result);   /**<Multiply the PLL input by the multiplication factor entered by the user
                                                                       and check if the PLL input frequency is less than 72mHZ*/
